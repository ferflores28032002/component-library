...
export const theme = extendTheme({
  ...
  semanticTokens: {
    colors: {
      ...
      //Content color
      coArticle: { default: "baRose.500", _dark: "baRose.60" },
      coVideo: { default: "baViolet.500", _dark: "baViolet.600" },
      coAudio: { default: "baVioletRed.500", _dark: "baVioletRed.600" },
      coPdf: { default: "baOceanBlue.500", _dark: "baOceanBlue.600" },
      coImage: { default: "baCeruleanBlue.500", _dark: "baCeruleanBlue.600" },
      coGallery: { default: "baScooter.500", _dark: "baScooter.600" },
      coExternal: { default: "baRoyalBlue.500", _dark: "baRoyalBlue.600" },
      coHtml: { default: "baGreen.500", _dark: "baGreen.600" },
      // coDocument: '--',
      coZip: { default: "baJade.500", _dark: "baJade.600" },
      coTask: { default: "baAtlantis.500", _dark: "baAtlantis.600" },
      // coLink: '--',
      coGame: { default: "baCalifornia.500", _dark: "baCalifornia.600" },
      coTest: { default: "baAmber.500", _dark: "baAmber.600" },
      coPoll: { default: "baPear.500", _dark: "baPear.600" },
      coPlaylist: { default: "neGrey.500", _dark: "neGrey.600" },
      coChallenge: { default: "neGrey.500", _dark: "neGrey.600" },
      coUrl: { default: "baPear.500", _dark: "baPear.600" },

      //Path colors
      paCourse: { default: "baPomegranate.500", _dark: "baPomegranate.600" },
      paExpress: { default: "baPear.500", _dark: "baPear.600" },
      paInstagram: { default: "baScooter.500", _dark: "baScooter.600" },
      paJourney: { default: "baRose.500", _dark: "baRose.600" },
      paCards: { default: "baCeruleanBlue.500", _dark: "baCeruleanBlue.600" },
      paSingle: { default: "baCalifornia.500", _dark: "baCalifornia.600" },
